...
import { ArrowLeft, Cpu, Lock, Mail } from "lucide-react";
      ...
      <div className="relative z-10 flex flex-1 items-center justify-center py-8">
        <div className="w-full max-w-md">
                ...
                children={(field) => (
                  <>
                    <div className="flex items-center justify-between">
                      ...
                      <Link
                        href="#"
                        className="text-xs text-[#00b4db] hover:text-white transition-colors"
                      >
          ...
          <div className="mt-8 text-center text-sm text-gray-400">
            ...
            <Link
              href="/register"
              className="text-white font-medium hover:text-[#00b4db] transition-colors"
            >
              Regístrate aquí
            </Link>
          </div>
