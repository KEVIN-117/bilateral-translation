...
export default function LoginPage() {
  return (
    <div className="relative flex min-h-[calc(100svh-4rem)] flex-col items-center justify-center overflow-hidden px-4 py-10 sm:px-6 md:min-h-[calc(100svh-5rem)]">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[320px] w-[320px] sm:h-[600px] sm:w-[600px] bg-[#72004c] rounded-full blur-[150px] opacity-20 pointer-events-none animate-pulse" />
